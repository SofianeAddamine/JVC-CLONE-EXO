...
<html>
        ...
        <body>	
                ...
                <form class="text-center p-5 w-50 mx-auto mt-5" method="post" action="editor.list.php?Add=1">

                        <p class="h4 mb-4">Ajouter un éditeur</p>

                        <label class="mt-4">Nom de l'éditeur</label>
                        <input required type="text" class="form-control mb-4 w-50 mx-auto" placeholder="Champ obligatoire" name="name">
                        <label class="mt-4">Site de l'éditeur</label>
