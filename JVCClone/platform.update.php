<!DOCTYPE html>
	...
	<body>	
		...
		<form class="text-center p-5 w-50 mx-auto mt-5" method="post" action="platform.list.php?Update=1">
			...
			<?php
				...
				$sql = $pdo->query('SELECT * FROM platform WHERE pk_platform = '.$_GET['ID'])->fetch(PDO::FETCH_ASSOC);

				echo "<input type='hidden' name='id' value=".$sql['pk_platform'].">";
				echo "<label class='mt-4'>Nom de la plateforme</label>";
